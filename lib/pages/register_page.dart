...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future signUp() async{
    if (confirmpass()) {
      ...
      //add user data
      GetData(_firstName.text.trim(), _email.text.trim(),_age.text.trim(),gp);
    } else {
      showDialog(
          context: context,
          builder: (context) {
  ...
  Future GetData(String firstName, String email, String age, String gp) async {
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              onFieldSubmitted: (vale) {
                                FocusScope.of(context).requestFocus(nd_dob);
                              },
                              controller: _email,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
